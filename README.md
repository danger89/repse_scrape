...
* En los códigos de extracción de datos, se utiliza la versión de Windows del programa "**driver.exe**". Para correr el código en otro sistema operativo, se requiere reemplazar este programa con la versión correspondiente, que se puede encontrar en [esta liga]: https://chromedriver.chromium.org/downloads
